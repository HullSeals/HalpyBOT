            ...
            try:
                ...
                if twitter:
                    ...
                    if exact_sys:
                        ...
                        return f"Non-EDSM system calculated to be {distance} LY {direction} of {landmark}." if twitter \
                    ...
                    if found_sys:
                        try:
                            ...
                            if str(er) == f"No major landmark systems within 10,000 ly of {close_sys}.":
                                ...
                                return f"Non-EDSM system calculated to be {distance} LY {direction} of {dssa}." if \
                                    twitter else f"\n{sys_name} could not be found in EDSM. System closest in name " \
                                                 f"found in EDSM was {close_sys}.\n{er}\nThe closest DSSA Carrier is " \
